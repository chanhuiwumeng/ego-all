...
<div class="wrapper">
            ...
            <ul class="sidebar-menu">
                ...
                <ul class="treeview-menu">
                    <li onclick="makecss(this)" data-id="categoryList_Goods">
                        <a href='category/toCategoryList' target='rightContent'><i class="fa fa-circle-o"></i>商品分类</a>
    ...
    <section class="content-wrapper right-side" id="riframe" style="margin:0px;padding:0px;margin-left:230px;">
        <iframe id='rightContent' name='rightContent' src="page/toWelcome" width='100%' frameborder="0"></iframe>
    </section>
